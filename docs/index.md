...
[<img src="img/roaring-mouse.webp" width="256" alt="Mavis Mouse" align="right">](/)
...
Mavis AAC works on [MacOS](../macos/) as well as [iPads and iPhones](../ios/). It is very similar on all platforms, but each version has small tweaks so that Mavis feels better integrated with your device.
...
Download [Mavis-AAC.dmg](https://github.com/msolo/Mavis/releases/download/latest/Mavis-AAC.dmg) and run the application.
